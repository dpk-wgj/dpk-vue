...
export default {
    ...
    methods: {
        ...
        initMap () {
            ...
            AMapUI.load(['misc/PathSimplifier', 'lib/$'], function(PathSimplifier, $) {
                ...
                this.navg1.start();
                AMap.setFitView();//根据地图上添加的覆盖物分布情况，自动缩放地图到合适的视野级别，参数overlayList默认为当前地图上添加的所有覆盖物图层
            });
